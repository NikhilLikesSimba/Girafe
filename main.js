...
function startClassification()
{
    ...
    classifier = ml5.soundClassifier ('https://teachablemachine.withgoogle.com/models/oj4v8pJsr/model.json', modelReady);
...
function gotResults(error, results) {
    if (error) {
        ...
        } else if (results[0].label == "Fan") {
            img1.src='aliens-01.png';
            img2.src='aliens-02.gif';
            img3.src='aliens-03.png';
            img4.src='aliens-04.png';
        } else if (results[0].label == "MouthThingy") {
            img1.src='aliens-01.png';
            img2.src='aliens-02.png';
